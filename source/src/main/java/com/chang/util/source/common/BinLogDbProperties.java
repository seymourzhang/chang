...
public class BinLogDbProperties {
   private String host;
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof BinLogDbProperties)) {
         return false;
      } else {
         BinLogDbProperties other = (BinLogDbProperties)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof BinLogDbProperties;
   }
   ...
   public String toString() {
      return "BinLogDbProperties(host=" + this.getHost() + ", port=" + this.getPort() + ", userName=" + this.getUserName() + ", password=" + this.getPassword() + ", database=" + this.getDatabase() + ", syncDbType=" + this.getSyncDbType() + ", lookTableList=" + this.getLookTableList() + ", blacklist=" + this.getBlacklist() + ")";
   }
}
