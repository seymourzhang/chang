...
public class MqttClientOptions {
   ...
   public String toString() {
      return "MqttClientOptions(broker=" + this.getBroker() + ", publishTopic=" + this.getPublishTopic() + ", publishQos=" + this.getPublishQos() + ", subsrcibeTopics=" + this.getSubsrcibeTopics() + ", subsrcibeQoss=" + this.getSubsrcibeQoss() + ", clientID=" + this.getClientID() + ", userName=" + this.getUserName() + ", passWord=" + this.getPassWord() + ", keepAlive=" + this.getKeepAlive() + ", maxInflight=" + this.getMaxInflight() + ", connectionTimeout=" + this.getConnectionTimeout() + ", cleanSession=" + this.isCleanSession() + ", autoGenerationClientID=" + this.isAutoGenerationClientID() + ", callBackClass=" + this.getCallBackClass() + ", actionClass=" + this.getActionClass() + ", payLoadClass=" + this.getPayLoadClass() + ", needSubsrcibe=" + this.isNeedSubsrcibe() + ", retained=" + this.isRetained() + ", sslEnable=" + this.getSslEnable() + ", caCrtFile=" + this.getCaCrtFile() + ", crtFile=" + this.getCrtFile() + ", keyFile=" + this.getKeyFile() + ", sslPassword=" + this.getSslPassword() + ")";
   }

   public MqttClientOptions(String broker, String publishTopic, int publishQos, String subsrcibeTopics, String subsrcibeQoss, String clientID, String userName, String passWord, int keepAlive, int maxInflight, int connectionTimeout, boolean cleanSession, boolean autoGenerationClientID, String callBackClass, String actionClass, String payLoadClass, boolean needSubsrcibe, boolean retained, Boolean sslEnable, String caCrtFile, String crtFile, String keyFile, String sslPassword) {
   ...
   public static class MqttClientOptionsBuilder {
      ...
      public MqttClientOptionsBuilder maxInflight(int maxInflight) {
         this.maxInflight = maxInflight;
         return this;
      }
      ...
      public MqttClientOptionsBuilder cleanSession(boolean cleanSession) {
         this.cleanSession = cleanSession;
         return this;
      }

      public MqttClientOptionsBuilder autoGenerationClientID(boolean autoGenerationClientID) {
         this.autoGenerationClientID = autoGenerationClientID;
         return this;
      }
      ...
      public MqttClientOptions build() {
         ...
         return new MqttClientOptions(this.broker, this.publishTopic, this.publishQos, this.subsrcibeTopics, this.subsrcibeQoss, this.clientID, this.userName, this.passWord, this.keepAlive, this.maxInflight, this.connectionTimeout, this.cleanSession, this.autoGenerationClientID, this.callBackClass, this.actionClass, this.payLoadClass, needSubsrcibe$value, retained$value, sslEnable$value, this.caCrtFile, this.crtFile, this.keyFile, this.sslPassword);
      }

      public String toString() {
         return "MqttClientOptions.MqttClientOptionsBuilder(broker=" + this.broker + ", publishTopic=" + this.publishTopic + ", publishQos=" + this.publishQos + ", subsrcibeTopics=" + this.subsrcibeTopics + ", subsrcibeQoss=" + this.subsrcibeQoss + ", clientID=" + this.clientID + ", userName=" + this.userName + ", passWord=" + this.passWord + ", keepAlive=" + this.keepAlive + ", maxInflight=" + this.maxInflight + ", connectionTimeout=" + this.connectionTimeout + ", cleanSession=" + this.cleanSession + ", autoGenerationClientID=" + this.autoGenerationClientID + ", callBackClass=" + this.callBackClass + ", actionClass=" + this.actionClass + ", payLoadClass=" + this.payLoadClass + ", needSubsrcibe$value=" + this.needSubsrcibe$value + ", retained$value=" + this.retained$value + ", sslEnable$value=" + this.sslEnable$value + ", caCrtFile=" + this.caCrtFile + ", crtFile=" + this.crtFile + ", keyFile=" + this.keyFile + ", sslPassword=" + this.sslPassword + ")";
      }
   }
}
