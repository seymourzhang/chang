package com.chang.servlet.kafka.configuration.config;
...
public class KafkaProperties {
   ...
   public String toString() {
      return "KafkaProperties(servers=" + this.getServers() + ", groupId=" + this.getGroupId() + ", topic=" + this.getTopic() + ", messageType=" + this.getMessageType() + ", parm=" + this.getParm() + ")";
   }
}
